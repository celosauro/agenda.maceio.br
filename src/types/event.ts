// Enum centralizado de categorias - fácil adicionar/remover
// Usando "as const" para compatibilidade com configuração TypeScript strict
...
// Configuração de cada categoria com label e cores
// Cores pastel com texto escuro para garantir contraste WCAG AA (4.5:1)
...
export const CATEGORY_CONFIG: Record<EventCategory, CategoryConfig> = {
  ...
  [EventCategory.BARZINHO]: {
    label: 'Barzinho',
    bgColor: 'bg-amber-200',
    textColor: 'text-amber-900',
    borderColor: 'border-amber-300',
    icon: 'M17 11h1a3 3 0 0 1 0 6h-1M9 12v6M13 12v6M14 7.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 0 1 0-5c.78 0 1.57.5 2.5.5S9.44 2 11 2s2 1.5 3 1.5 1.72-.5 2.5-.5a2.5 2.5 0 0 1 0 5c-.78 0-1.5-.5-2.5-.5ZM5 8v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8',
  },
};
...
export interface Event {
  ...
  thumbnail?: string;
  date: string; // ISO 8601 format: "2026-02-15T19:00:00"
  description: string;
  location: string;
  address: string;
...
export type DateFilter = 'all' | 'today' | 'tomorrow' | 'this-week' | 'next-week' | 'weekend';
